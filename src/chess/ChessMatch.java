...
public class ChessMatch {
	...
	//bleh
	public Position getPromotedPosition() {
		return promoted.getChessPosition().toPosition();
	}
	...
	private Piece makeMove(Position source, Position target) {
		...
		//#ataque especial roque lado do rei
		...
		//#ataque especial roque lado do rainha
	...
	private void validateSoucePosition(Position position) {
		...
		if (currentPlayer != ((ChessPiece) board.piece(position)).getColor()) {
			throw new ChessException("That chosen piece is not yours");
		}
	...
	private void validateTargetPosition(Position source, Position target) {
		if (!board.piece(source).possibleMove(target)) {
			throw new ChessException("That is not a possible move");
		}
	}
	...
	private ChessPiece king(Color color) {
		...
		for (Piece p : list) {
			// usa-se o "instanceof" para checar a CLASSE do objeto
